...
class Departamento:
    ...
    def mostrarDepartamento(self):
        print('{}. departamento {}'.format(self.id,self.descripcion))
        print(' ')
...
class Empleado(ABC): 
    ...
    def mostrarEmpleado(self):
        print(' {} Empleado : {} Cedula: {} dirección : {} Cargo: {} Depto: {}'.format(self.id,self.nombre,self.cedula,self.direccion,self.cargo.descripcion,self.departamento.descripcion),end=" ")
...
class Administrativo(Empleado):
    ...
    def mostrarEmpleado(self): 
        print(' {} Administrativo : {} Cedula: {} dirección : {} Cargo: {} Depto: {}'.format(self.id,self.nombre,self.cedula,self.direccion,self.cargo.descripcion,self.departamento.descripcion),end=" ")
...
class Obrero(Empleado):
    ...
    def mostrarEmpleado(self): 
        print(' {} Obrero : {} Cedula: {} dirección : {} Cargo: {} Depto: {}'.format(self.id,self.nombre,self.cedula,self.direccion,self.cargo.descripcion,self.departamento.descripcion),end=" ")
...
class Deduccion:
    ...
    def mostrarDeduccion(self):
        print('Valor por Iess {} = \n Valor por comision ({}) = \n Valor por antiguedad ({}) ='.format(self.iess, self.comision, self.antiguedad))
...
class Nomina:
    ...
    def mostrarCabeceraNomina(self,razonSocial, direccion, telefono, ruc,tipoRol):
        borrarPantalla()
        print('{} Ruc : {} Teléfono : {} Dirección Domiciliara: {}'.format(razonSocial,ruc,telefono,direccion))
        print('*********************************')
        print('Fecha: {}  Pago a empleados: {}  '.format(self.fecha,tipoRol))
        print('Nomina del Periodo:{}'.format(self.aamm))
        print('--'*59) 
        print(" "*5,"Empleado"," "*30,"Ingreso"," "*22,"Egreso")
        print("Nombre     Cargo          Departamento    Sueldo   HorasExtras  Antiguedad  Comision TotIng   Iess    Prestamo   TotDes   Neto")
